...
import neembuu.httpserver.Utils;
...
public class ElementalHttpServer {
    ...
    public static void main(String[] args) throws Exception {
        args=new String[]{"J:\\neembuu\\realfiles"};
        args=new String[]{"C:\\Users\\Shashank Tulsyan\\.neembuu-now\\release1\\NeembuuVirtualFolder"};
        if (args.length < 1) {
    ...
    static class HttpFileHandler implements HttpRequestHandler  {
        ...
        public void handle(
            ...
            if (!file.exists()) {
                ...
                long offset = Utils.standardOffsetResponse(request, response, file.length());
                MonitoredFileEntity body = new MonitoredFileEntity(
                        file, "application/octet-stream",offset);
