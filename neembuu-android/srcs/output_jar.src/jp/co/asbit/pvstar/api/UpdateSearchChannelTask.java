...
public class UpdateSearchChannelTask
  extends AsyncTask<URL, Integer, ArrayList<Playlist>>
{
  private static final String SEARCH_CHANNEL_API = "http://pvstar.dooga.org/api2/channels/searches/?query=%s&page=%s&per_page=%s";
  protected int totalResults = 200;
  protected String uri = "";
  
  public UpdateSearchChannelTask(String paramString, int paramInt1, int paramInt2)
  {
    try
    {
      ...
      this.uri = String.format("http://pvstar.dooga.org/api2/channels/searches/?query=%s&page=%s&per_page=%s", arrayOfObject);
      return;
    }
  ...
  protected ArrayList<Playlist> doInBackground(URL... paramVarArgs)
  {
    ...
    //   36: dup
    //   37: aload_0
    //   38: getfield 25	jp/co/asbit/pvstar/api/UpdateSearchChannelTask:uri	Ljava/lang/String;
    ...
    //   157: astore 22
    //   159: aload_0
    //   160: invokevirtual 122	jp/co/asbit/pvstar/api/UpdateSearchChannelTask:isCancelled	()Z
    //   163: istore 23
    //   165: iload 23
    //   167: ifeq +45 -> 212
    //   170: aload 4
    ...
    //   285: putfield 21	jp/co/asbit/pvstar/api/UpdateSearchChannelTask:totalResults	I
    //   288: iload 17
    //   290: ifeq +33 -> 323
    //   293: aload 22
    //   295: ldc 148
    ...
    //   0	644	0	this	UpdateSearchChannelTask
 ...
 * Qualified Name:     jp.co.asbit.pvstar.api.UpdateSearchChannelTask
