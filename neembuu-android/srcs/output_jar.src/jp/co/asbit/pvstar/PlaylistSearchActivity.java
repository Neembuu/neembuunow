...
import jp.co.asbit.pvstar.api.UpdateSearchPlaylistTask;

public class PlaylistSearchActivity
  ...
  implements AbsListView.OnScrollListener
{
  ...
  private void updateListView()
  {
    ...
    for (;;)
    {
      ...
      setTitle(getString(2131296442, arrayOfObject));
      this.mTask = new UpdateSearchPlaylistTask(this.query, this.page, this.per_page)
      {
        protected void onPostExecute(ArrayList<Playlist> paramAnonymousArrayList)
        {
          if (paramAnonymousArrayList != null) {
            PlaylistSearchActivity.this.addListData(paramAnonymousArrayList, this.totalResults);
          }
        ...
        protected void onPreExecute()
        {
          if (PlaylistSearchActivity.this.page == 1)
          {
            ...
            PlaylistSearchActivity.this.progressDialog.setMessage(PlaylistSearchActivity.this.getString(2131296481));
  ...
  protected ListView getListView()
  {
    if (this.mListView == null) {
      this.mListView = ((ListView)findViewById(2131492964));
    }
  ...
  protected void onCreate(Bundle paramBundle)
  {
    ...
    setContentAndTitle(2130903076, 2130903086);
    setTitle(getString(2131296405));
    ListView localListView = getListView();
    localListView.addFooterView(getFooter());
    ...
    localListView.setOnItemClickListener(new AdapterView.OnItemClickListener()
    {
      public void onItemClick(AdapterView<?> paramAnonymousAdapterView, View paramAnonymousView, int paramAnonymousInt, long paramAnonymousLong)
      {
        ...
        {
          Intent localIntent = new Intent(PlaylistSearchActivity.this.mContext, PlaylistActivity.class);
          localIntent.putExtra("PLAYLIST", localPlaylist);
          PlaylistSearchActivity.this.startActivity(localIntent);
        }
      }
    });
    if (this.query == null) {
  ...
  static class PlaylistRowAdapter
    extends ArrayAdapter<Playlist>
  {
    private LayoutInflater layoutInflater_;
    
    public PlaylistRowAdapter(Context paramContext, int paramInt, List<Playlist> paramList)
    {
    ...
    public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
    {
      ...
      PlaylistSearchActivity.ViewHolder localViewHolder;
      String str;
      Bitmap localBitmap;
      if (paramView == null)
      {
        paramView = this.layoutInflater_.inflate(2130903096, null);
        localViewHolder = new PlaylistSearchActivity.ViewHolder();
        ...
        localViewHolder.duration.setText(localPlaylist.getVideoCount() + " videos");
      ...
      for (;;)
      {
        try
        {
          ...
          return paramView;
          localViewHolder = (PlaylistSearchActivity.ViewHolder)paramView.getTag();
        }
 ...
 * Qualified Name:     jp.co.asbit.pvstar.PlaylistSearchActivity
