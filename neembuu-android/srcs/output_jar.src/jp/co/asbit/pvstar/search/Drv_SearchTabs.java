...
public class Drv_SearchTabs
{
  ...
  public Drv_SearchTabs(Context paramContext, String[] paramArrayOfString)
  {
  ...
  public void changeTabState(View paramView, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      ...
      return;
      paramView.setBackgroundColor(Color.rgb(240, 240, 240));
    }
  }
  ...
  public Drv_SearchTabs setOnTabSelectedListener(OnTabSelectedListener paramOnTabSelectedListener)
  {
 ...
 * Qualified Name:     jp.co.asbit.pvstar.search.Drv_SearchTabs
