...
public class AMoAdSdkPopUpForUnityActivity
  extends Activity
{
  public void onCreate(Bundle paramBundle)
  {
    ...
    RelativeLayout localRelativeLayout = (RelativeLayout)getLayoutInflater().inflate(localResources.getIdentifier("amoadsdk_popup_unity", "layout", getPackageName()), null);
    ...
    ((Button)localRelativeLayout.getChildAt(1)).setOnClickListener(new View.OnClickListener()
    {
      ...
      {
        new ClickPopResultSetSendTask(str3, AMoAdSdkPopUpForUnityActivity.this, str1).execute(new String[0]);
        Intent localIntent = new Intent(AMoAdSdkPopUpForUnityActivity.this, AMoAdSdkWallActivity.class);
        AMoAdSdkPopUpForUnityActivity.this.startActivity(localIntent);
        AMoAdSdkPopUpForUnityActivity.this.finish();
      }
    });
 ...
 * Qualified Name:     com.amoad.amoadsdk.AMoAdSdkPopUpForUnityActivity
