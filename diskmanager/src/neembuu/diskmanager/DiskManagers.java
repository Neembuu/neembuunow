 ...
 */
public final class DiskManagers {
    
    /*private static class holder {
        private static DiskManager instance = new DefaultDiskManager("j:\\neembuu\\heap");
    }*/
    
    public static DiskManager getDefaultManager(DiskManagerParams dmp){
        return new DefaultDiskManager(dmp);
