...
public class InitLookAndFeel {
    ...
    private static void toolTip(){
        ...
        /*UIManager.put("ToolTip[Enabled].backgroundPainter", new Painter() {
            @Override public void paint(Graphics2D g, Object object, int width, int height) {
                g.setColor(new Color(255,255,255,255));
                g.fillRect(0, 0, width, height);
            }
        });*/
        UIManager.put("ToolTip.font",new FontUIResource(Fonts.MyriadPro.deriveFont(14f)));
    }
