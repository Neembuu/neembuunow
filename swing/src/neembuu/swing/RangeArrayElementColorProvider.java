 ...
 */
public interface RangeArrayElementColorProvider {

    public enum SelectionState {
        MOUSE_OVER, SELECTED, LIST, NONE
    }

    public Color getColor(Color defaultColor, Range element, SelectionState selectionState);
    //public Paint getPaint(RangeArrayElement element, boolean isSelected, Dimension componentDimension);
}
